...
namespace SSD_Components
{
	...
	GC_and_WL_Unit_Page_Level::GC_and_WL_Unit_Page_Level(const sim_object_id_type& id,
		...
		: GC_and_WL_Unit_Base(id, address_mapping_unit, block_manager, host_interface, tsu, flash_controller, block_selection_policy, gc_threshold, preemptible_gc_enabled, gc_hard_threshold,
	...
	void GC_and_WL_Unit_Page_Level::process_zone_reset_request(User_Request* user_request){
		DEBUG("GC_and_WL_Unit_Page_Level handle and process (finish) RESET request!");
		_my_instance->broadcast_user_request_serviced_signal(user_request);
	}
